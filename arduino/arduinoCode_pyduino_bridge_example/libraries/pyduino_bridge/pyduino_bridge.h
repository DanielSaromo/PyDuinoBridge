...
#define buffSize 40
#define numIntValues 1   //Number of integer values that are going to be in the message
#define numFloatValues 1 //Number of float   values that are going to be in the message
...
class Bridge_ino
{
  public:
    ...
    int intsRecvd[numIntValues];
    float floatsRecvd[numFloatValues];
